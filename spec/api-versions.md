...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/v2f052e0cca7362dede225b85c12aee59eabee5b8fbb05d44fc345ffb54861aec/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/api-versions"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/api-versions" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/api-versions" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/api-versions?hl=sq" /><title>API versions explained &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="API versions explained &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/api-versions"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2.png">
  ...
  <meta property="og:image:height" content="675"><meta property="og:locale" content="en"><meta name="twitter:card" content="summary_large_image"><script type="application/ld+json">
  {
    ...
    "headline": "API versions explained"
  }
</script><script type="application/ld+json">
  {
    ...
    "itemListElement": [{
      ...
      "@type": "ListItem",
      "position": 2,
      "name": "API versions explained",
      "item": "https://ai.google.dev/gemini-api/docs/api-versions"
    }]
  }
  </script>
...
<li class="devsite-nav-item">
  ...
  <li class="devsite-nav-item
           devsite-nav-beta"><a href="/api/interactions-api"
        class="devsite-nav-title"
...
<article class="devsite-article">
    ...
    background="google-blue"
      ...
      <div class="devsite-banner-message">
        <div class="devsite-banner-message-text">
          Try the new <a href="/gemini-api/docs/models/gemini-3.1-flash-tts-preview" style="color: black;">Gemini 3.1 Flash TTS Preview</a> model for expressive, multilingual speech generation.
        </div>
      </div>
    </div>
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      API versions explained<devsite-actions hidden data-nosnippet>
...
<aside class="special" style="margin: 20px 0;">
  <p>We have updated our <a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener">Terms of Service</a>.
  </p>
</aside>

<p>This document provides a high-level overview of the differences between the <code translate="no" dir="ltr">v1</code>
and <code translate="no" dir="ltr">v1beta</code> versions of the Gemini API.</p>

<ul>
<li><strong>v1</strong>: Stable version of the API. Features in the stable version are
...
version.</li>
<li><strong>v1beta</strong>: This version includes early features that may be under development and are subject to breaking changes. There is also no guarantee that the features in the Beta version will move to the stable version. <strong>If you require stability in your production environment and cannot risk breaking changes, you should not use this version in production.</strong></li>
</ul>
...
<tbody>
<tr>
<td>Generate Content - Text-only input</td>
<td><span class="compare-yes"></span></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
<td>Generate Content - Text-and-image input</td>
<td><span class="compare-yes"></span></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
<td>Generate Content - Text output</td>
<td><span class="compare-yes"></span></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
<td>Generate Content - Multi-turn conversations (chat)</td>
<td><span class="compare-yes"></span></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
<td>Generate Content - Function calls</td>
<td></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
<td>Generate Content - Streaming</td>
<td><span class="compare-yes"></span></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
<td>Embed Content - Text-only input</td>
<td><span class="compare-yes"></span></td>
<td><span class="compare-yes"></span></td>
</tr>
<tr>
...
<ul>
<li><span class="compare-yes"></span> - Supported</li>
<li><span class="compare-no"></span> - Will never be supported</li>
</ul>

<h2 id="configure-api-version" data-text="Configure API version in an SDK" tabindex="-1">Configure API version in an SDK</h2>

<p>The Gemini API SDK&#39;s default to <code translate="no" dir="ltr">v1beta</code>, but you can opt to use other versions
by setting the API version as shown in the following code sample:</p>
...
<span class="devsite-syntax-n">client</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">genai</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">Client</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">http_options</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-p">{</span><span class="devsite-syntax-s1">'api_version'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-s1">'v1'</span><span class="devsite-syntax-p">})</span>
...
<span class="devsite-syntax-n">response</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">models</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">generate_content</span><span class="devsite-syntax-p">(</span>
    <span class="devsite-syntax-n">model</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-s1">'gemini-3-flash-preview'</span><span class="devsite-syntax-p">,</span>
    <span class="devsite-syntax-n">contents</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-s2">"Explain how AI works"</span><span class="devsite-syntax-p">,</span>
...
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-nx">httpOptions</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">apiVersion</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"v1"</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">},</span>
<span class="devsite-syntax-p">});</span>
...
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nx">model</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"gemini-3-flash-preview"</span><span class="devsite-syntax-p">,</span>
...
<section><h3 id="rest" data-text="REST" tabindex="-1">REST</h3><div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">curl<span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"https://generativelanguage.googleapis.com/v1/models/gemini-3-flash-preview:generateContent"</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-se">\</span>
...
<span class="devsite-syntax-s1">    "parts":[{"text": "Explain how AI works."}]</span>
...
<devsite-content-footer class="nocontent" data-nosnippet>
  ...
  <p>Last updated 2026-03-23 UTC.</p>
